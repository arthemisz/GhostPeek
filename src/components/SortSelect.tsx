  ...
  return (
    <div className="relative">
      ...
      <select
        ...
        className="appearance-none rounded-md border border-gray-700/40 bg-gray-900/50 py-1.5 pl-8 pr-6 text-xs text-gray-300 transition-colors focus:border-teal-500 focus:outline-none focus:ring-1 focus:ring-teal-500/40"
      >
